...
import { QuizLandingPage } from "@/src/pages/QuizLandingPage";
import { MoneyFlowPage } from "@/src/pages/MoneyFlowPage";
import { InspirationPage } from "@/src/pages/InspirationPage";
      ...
      <div className="flex-1 relative">
        <AnimatePresence mode="wait">
          <Switch location={location} key={location}>
            ...
            <Route path="/quiz">
              <PageTransition><QuizLandingPage onBack={goBack} onJoin={() => setModal(true)} /></PageTransition>
            </Route>
            ...
            <Route path="/blueprint"><PageTransition><BlueprintPage onBack={goBack} onAppointment={() => navigate("/appointment")} /></PageTransition></Route>
            <Route path="/inspire"><PageTransition><InspirationPage onBack={goBack} /></PageTransition></Route>
            <Route path="/inspiration"><PageTransition><InspirationPage onBack={goBack} /></PageTransition></Route>
            <Route path="/money-flow"><PageTransition><MoneyFlowPage onBack={goBack} /></PageTransition></Route>
            <Route path="/story"><PageTransition><StoryPage onBack={goBack} onJoin={() => setModal(true)} /></PageTransition></Route>
