  ...
  return (
    <div className="min-h-screen bg-warm-gray-50 font-sans pb-6">
      ...
      <div className="pt-12 pb-6 px-6 relative z-10 w-full max-w-sm mx-auto flex items-center justify-between">
        ...
        <div className="text-[13px] font-medium text-warm-gray-800 tracking-wider uppercase border-b border-warm-gray-800 pb-0.5">{title}</div>
        <div className="w-10" />
      </div>

      <div className="p-5 text-center mt-12 relative z-10 w-full max-w-sm mx-auto">
        <div className="w-[72px] h-[72px] bg-white border border-warm-gray-200 rounded-full mx-auto flex items-center justify-center mb-8 shadow-sm">
        ...
        <div className="border border-warm-gray-200 bg-white py-5 px-6 inline-flex items-center justify-center gap-3 w-full rounded-lg">
          <div className="text-[12px] font-medium text-warm-gray-800 tracking-[0.2em] uppercase">功能建置中 敬請期待</div>
        </div>
      </div>
    </div>
  );
